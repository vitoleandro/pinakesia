 ...
 */
declare const wrapProperty: <K extends keyof vue.default, T extends boolean = true>(property: K, makeComputed?: T | undefined) => () => T extends true ? ComputedRef<vue.default[K]> : vue.default[K];
/**
